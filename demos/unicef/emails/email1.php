		...
		<table width='720' cellpadding='0' cellspacing='0'>
			<tr>
			<td colspan=2 style='background:#25a6e0;width:720px'><a target='_blank' href='http://unicef.ca/portal/SmartDefault.aspx'><img border='0' src='http://staging.lushconcepts.com/demos/unicef/slaythemonster/img/header_email_en.jpg' /></a></td>
			</tr>
			<tr valign='top'>
			...
			<td style='width:430px;padding:25px 0 0 0px;font-family: Arial;'>
					<h1 style='color:#25a6e0;font-size:25px;padding-top:7px;'>Hi <?=$_GET['name']?></h1>
					<p style='font-size:13px;color: #7f7f7f;'><?=$_GET['nameSender']?> has written a story just for you! To see it, just click on the link below.</p>
					<p style='font-size:13px;color: #7f7f7f;'><?=$_GET['message']?></p>
					<p align='right'><a  style='font-size:13px;color: #25a6e0;' href='http://staging.lushconcepts.com/demos/unicef/slaythemonster/step3/php/<?=$_GET['pdf']?>.pdf'>View your story</a></p>
					<hr style='border:0px;height:1px;clear:both;margin:15px 0 0px 0;background-color:#25a6e0;color:#25a6e0;line-height:1px;' />
					<img style='' src='http://staging.lushconcepts.com/demos/unicef/slaythemonster/img/fly_email_en.jpg' />
					<p style='clear:both;'>
					...
					<hr style='border:0px;height:1px;clear:both;margin:15px 0 15px 0;background-color:#25a6e0;color:#25a6e0;line-height:1px;' />
					<h1 style='color:#25a6e0;font-size:18px;'>Create a monster story for someone you know!</h1>
