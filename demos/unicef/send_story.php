	...
	$body = <<<END
		...
		<table width='720' cellpadding='0' cellspacing='0'>
			...
			<td style='width:430px;padding:25px 0 0 0px;font-family: Arial;'>
					...
					<p style='font-size:13px;color: #7f7f7f;'>{$_POST['name']} has written a story to share with you! To see it, just click on the link below.</p>
					<p style='font-size:13px;color: #7f7f7f;'>{$message}</p>
					<p align='right'><a  style='font-size:13px;color: #25a6e0;' href='http://staging.lushconcepts.com/demos/unicef/slaythemonster/step3/php/{$_POST['pdf']}.pdf'>View your story</a></p>
...
if ($_POST['lang'] == 'EN'){
	...
	$subject = $_POST['name'] . ' vous met au défi de faire un don!';
}
...
<?
if ($_POST['lang'] == 'EN'){
	echo "<h1 style='padding:20px 0 0 0px; margin:0px;'>Thank you!<br>Your story has been sent.</h1>";
}else{
	echo "<h1>Thank you!<br>Your story has been sent.</h1>";
}
?>
