...
<script language="javascript">
	...
	<body>
		<div class='whole'>
				...
				<div class='right'>
				<h1 style='margin:20px 0 10px 0;padding-top:0px;'>Send your story to a friend!</h1>
				<p>You can send this story to all the children, friends and family in your life. Just fill out the form below, add your own message and send it along.</p>
	  <form method=post id='chalForm' action='send_story.php'>
 		  <input name=lang type=hidden value="EN">
 		  <input name=pdf type=hidden value="<?=$_GET['pdf']?>">
               <table width='650'>
                    <tr>
